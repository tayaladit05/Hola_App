...
exports.login = async (req, res) => {
  try {
    ...
    console.log('Login attempt:', { email, username, passwordProvided: !!password });
    ...
    console.log('User found:', user ? { id: user._id, email: user.email, username: user.username, isEmailVerified: user.isEmailVerified, hasPassword: !!user.password } : 'No user found');
